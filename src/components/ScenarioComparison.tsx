...
export default function ScenarioComparison({ scenarios }: Props) {
  ...
  return (
    <div>
      <button
        onClick={() => setOpen((v) => !v)}
        className="px-5 h-10 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition-colors cursor-pointer"
      >
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-lg border border-green-200 bg-green-50 p-4">
              ...
              <div className="text-lg font-bold text-green-900 mt-1">{cheapest.scenario.label}</div>
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
              ...
              <div className="text-lg font-bold text-blue-900 mt-1">{fastest.label}</div>
